...
The Internal CRB is marked as `EfiACPIMemoryNVS` via a HOB in [ArmPlatformLibQemu.c](https://github.com/OpenDevicePartnership/patina-qemu/blob/main/Platforms/QemuArmVirtPkg/Library/ArmPlatformLibQemu/ArmPlatformLibQemu.c)
